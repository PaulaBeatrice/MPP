...
import triathlon.persistence.orm.ParticipantRepositoryORM;
...
//        IService sv = new ServiceImpl(refereeDBRepository,participantDBRepository,resultDBRepository);
        ...
        ParticipantRepositoryORM participantRepositoryORM = new ParticipantRepositoryORM();
        ResultDBRepository resultDBRepository = new ResultDBRepository(serverProps,refereeDBRepository,participantRepositoryORM);
        IService sv = new ServiceImpl(refereeDBRepository,participantRepositoryORM,resultDBRepository);
